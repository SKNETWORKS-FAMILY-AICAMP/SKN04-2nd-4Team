from src.data import ChurnDataset, ChrunDataModule
...
def main(configs):
    ...
    # 훈련 데이터의 열을 표준화
    need_scale_cols = data.columns.difference(categorical_cols + ['RetentionCalls', 'RetentionOffersAccepted', 'IncomeGroup'])
    ...
    # 데이터 모듈 생성 및 데이터 준비
    diamonds_data_module = ChrunDataModule(batch_size=configs.get('batch_size'))
