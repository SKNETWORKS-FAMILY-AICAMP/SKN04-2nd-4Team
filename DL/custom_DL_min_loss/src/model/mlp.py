...
class Model(nn.Module):  # nn.Module을 상속받아 새로운 모델 클래스를 정의합니다.
    def __init__(self, configs):  # 생성자 메서드
        ...
        self.hidden_dim1 = configs.get('hidden_dim1')  # 숨겨진 층의 차원 크기를 저장합니다.
        self.hidden_dim2 = configs.get('hidden_dim2')  # 숨겨진 층의 차원 크기를 저장합니다.
        self.hidden_dim3 = configs.get('hidden_dim3')  # 숨겨진 층의 차원 크기를 저장합니다.
        ...
        self.linear1 = nn.Linear(self.input_dim, self.hidden_dim1)  # 입력 차원에서 숨겨진 차원으로의 선형 변환을 정의합니다.
        ...
        self.linear2 = nn.Linear(self.hidden_dim1, self.hidden_dim2)  # 입력 차원에서 숨겨진 차원으로의 선형 변환을 정의합니다.
        ...
        self.linear3 = nn.Linear(self.hidden_dim2, self.hidden_dim3)  # 입력 차원에서 숨겨진 차원으로의 선형 변환을 정의합니다.
        ...
        self.output = nn.Linear(self.hidden_dim3, self.output_dim)  # 숨겨진 차원에서 출력 차원으로의 선형 변환을 정의합니다.
